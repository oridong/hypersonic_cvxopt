%Skye Mceowen
%3D Projective Dynamics - Wang Sims
%Jan15, 2021


function xDot = dynamics_wang(t,x,sigma,T)
    ...
    % Compute alpha from velocity
    if V>4570
        alpha = 40;
    else
        alpha = 40-0.20705*(V-4570)^2/(340^2);
    end
    
    % Lift and drag ratio coefficients
    Cl = -0.041065 + 0.016292*alpha + 0.0002602*alpha^2;
    Cd = 0.080505 - 0.02036*Cl + 0.086495*Cl^2;
